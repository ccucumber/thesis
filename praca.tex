...
\begin{figure}[h!]
\begin{center}
 \includegraphics[width=0.7\textwidth]{./obrazki/vcsel_struktura.png}
 % rys-eel.gif: 0x0 pixel, 300dpi, 0.00x0.00 cm, bb=
\end{center}
...
DYSKUSJA 2H i 1H i w ogóle.
 ...
 Zależność amplitudy skręcenia w zależności od indukcji pola magnetycznego w komórce przedstawia rys. \ref{fig:magnetorot1}. Widać, że przebieg tej zależności ma postać krzywej rezonansowej, \begin{comment} następuje jednak niewielkie \end{comment}.
% CO NASTĘPUJE??? 
\begin{figure}[h!]
\centering
