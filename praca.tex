...
Oświetlenie atomów światłem o polaryzacji $\sigma_+$ (jak na rysunku) powoduje przepompowanie populacji atomów do stanu o $m_z$ maksymalnym ($m_z$=+1/2, oznaczmy go $\lvert + \rangle_z$). Dalsza absorpcja światła o polaryzacji $\sigma_+$ jest niemożliwa, ponieważ populacja stanu o $m_z$=-1/2 ($\lvert - \rangle_z$) jest pusta. Taki stan nazywamy stanem ciemnym, ponieważ nie absorbuje padającego światła. Dla zadanej polaryzacji  światła $\sigma_+$ stan ciemny to $\lvert + \rangle_z$, a stan jasny który absorbowałby światło to $\lvert - \rangle_z$. 
...
Prawdopodobieństwo znalezienia atomu w stanie jasnym, oddziałującym ze światłem, jest więc równe
 ...
 \begin{equation}
\lvert \langle \psi(t) \lvert - \rangle_x \rvert^2 = \sin^2 (\Omega_L t/2)= \frac{1}{2}\left(1-\cos(\Omega_L t/2) \right), 
\end{equation} 
...
\bibitem{spie} Proc. SPIE 7229, Vertical-Cavity Surface-Emitting Lasers XIII, 722903 (February 06, 2009); doi:10.1117/12.808294
