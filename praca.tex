...
Ruch tłumionego oscylatora harmonicznego z wymuszeniem opisuje
 krzywa rezonansowa \ref{krzywa}. Obserwując oprócz amplitudy wahania płaszczyzny polaryzacji także zależność fazową względem przebiegu modulującego, tj. składową w fazie i w kwadraturze, można wyodrębnić część absorpcyjną (symetryczną względem częstości rezonansowej) i elastyczną (asymetryczną).
